...
def main_matching():
    ...
    # Debug
    plot_image_with_keypoints(os.path.basename(IMG_NAME1[:-4]) + "_harris_f.png", img1, corners1)
    plot_image_with_keypoints(os.path.basename(IMG_NAME2[:-4]) + "_harris_f.png", img2, corners2)
